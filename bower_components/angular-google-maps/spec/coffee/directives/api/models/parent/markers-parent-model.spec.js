...
describe("MarkersParentModel - Clusterer Event Extensions", function() {
  ...
  beforeEach(function() {
    ...
    angular.module('mockModule', ["google-maps", "google-maps.mocks"]).value('map', document.gMap).value('element', {}).value('attrs', {
      click: true
    ...
    return inject((function(_this) {
      return function($rootScope, element, attrs, map, MarkersParentModel) {
        var $timeout, scope;
        scope = $rootScope.$new();
        $timeout = (function(fn) {
          return fn();
        ...
        _this.subject = new _this.testCtor(_this.scope, element, attrs, map, $timeout);
